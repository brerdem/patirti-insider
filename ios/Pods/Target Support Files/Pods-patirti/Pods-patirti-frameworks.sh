...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/InsiderHybrid/InsiderHybrid.framework"
  install_framework "${PODS_ROOT}/InsiderMobile/InsiderMobile.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNLocalize/RNLocalize.framework"
  ...
  install_framework "${PODS_ROOT}/InsiderMobileAdvancedNotification/InsiderMobileAdvancedNotification.framework"
