 ...
 */
+(InsiderProduct *)createNewProductWithID:(NSString *)productID name:(NSString *)name taxonomy:(NSString *)taxonomy imageURL:(NSString *)imageURL price:(double)price currency:(NSString *)currency;
...
/**
 ...
 @param language The language of the recommendation data is going to be retrieved.
 ...
 */
+(void)getSmartRecommendationWithID:(int)recommendationID language:(NSString *)language currency:(NSString *)currency smartRecommendation:(void (^)(NSDictionary *recommendation))smartRecommendation;
...
/**
 ...
 @param smartRecommendation The recommendation data retrieved from Insider Recommendation Engine.
 */
+(void)getSmartRecommendationWithProduct:(InsiderProduct *)product recommendationID:(int)recommendationID language:(NSString *)language smartRecommendation:(void (^)(NSDictionary *recommendation))smartRecommendation;
...
/**
 ...
 @param taxonomy Taxonomy(category) of the product.
 */
+(void)visitListingPageWithTaxonomy:(NSString *)taxonomy;
