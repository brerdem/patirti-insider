...
@class InsiderProduct; @interface InsiderProduct : NSObject {
    NSMutableDictionary *mSummary;
    bool mIsProductValid;
}

-(instancetype) init __attribute__((unavailable("init not available, use initProduct instead")));
-(instancetype)initProductWithID:(NSString *)productID name:(NSString *)name taxonomy:(NSString *)taxonomy imageURL:(NSString *)imageURL price:(double)price currency:(NSString *)currency;
...
*/
-(InsiderProduct*(^)(NSString *))setTaxonomy;
...
/**
 This method allows you to set the subCategory attribute of your InsiderProduct object, which will be only used for SmartRecommendation.
 */
-(InsiderProduct*(^)(NSString *))setSubCategory;
...
/**
 This method will return the subCategory of the InsiderProduct object.
 @return SubCategory of the InsiderProduct object.
 */
